...
*/
package com.vmware.flowgate.exception.handler;
...
import com.vmware.flowgate.exception.ApiError;
...
public class WormholeExceptionHander extends ResponseEntityExceptionHandler {
   ...
   public ResponseEntity<Object> handWormholeException(final WormholeRequestException ex,
      ...
      final ApiError apiError = new ApiError(ex.getStatus(),ex.getMessage(),ex.getErrorCode());
