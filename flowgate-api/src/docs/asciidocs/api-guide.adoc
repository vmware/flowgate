...
[[resources-assets-getAssetMetricsData]]
=== getAssetMetricsData
...
include::{snippets}/assets-getAssetMetricsData-Server-example/http-request.adoc[]

==== Example response

include::{snippets}/assets-getAssetMetricsData-Server-example/http-response.adoc[]

==== CURL request

include::{snippets}/assets-getAssetMetricsData-Server-example/curl-request.adoc[]

==== Response Fields

include::{snippets}/assets-getAssetMetricsData-Server-example/response-fields.adoc[]
