...
include::{snippets}/facilityadapter-deleteById-example/request-fields.adoc[]

[[resources-facilityadapter-queryByPage]]
=== getFacilityadapterWithPagenation

A `GET` request is used to access the facilityadapter read by Page.
...
include::{snippets}/facilityadapter-findByPage-example/request-fields.adoc[]

[[resources-facilityadapter-queryById]]
=== getFacilityadapterById

A `GET` request is used to access the facilityadapter by ID.
...
include::{snippets}/facilityadapter-findOneById-example/http-response.adoc[]
...
include::{snippets}/facilityadapter-findOneById-example/response-fields.adoc[]