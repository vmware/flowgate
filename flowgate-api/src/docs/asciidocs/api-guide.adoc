...
Wormhole API tries to adhere as closely as possible to standard HTTP and REST conventions in its
use of HTTP verbs.
...
A `GET` request is used to access the Asset read.
...
[[resources-assets-getMappingsByVropsId]]
=== getServerMappingsByVropsId

A `GET` request is used to access the ServerMapping read by VropsId.

==== Request structure

include::{snippets}/assets-getMappingsByVropsId-example/http-request.adoc[]

==== Example response

include::{snippets}/assets-getMappingsByVropsId-example/http-response.adoc[]

==== CURL request

include::{snippets}/assets-getMappingsByVropsId-example/curl-request.adoc[]

==== Response Fields

include::{snippets}/assets-getMappingsByVropsId-example/response-fields.adoc[]

[[resources-assets-getMappingsByVCId]]
=== getServerMappingsByVCId

A `GET` request is used to access the ServerMapping read by VCId.

==== Request structure

include::{snippets}/assets-getMappingsByVCId-example/http-request.adoc[]

==== Example response

include::{snippets}/assets-getMappingsByVCId-example/http-response.adoc[]

==== CURL request

include::{snippets}/assets-getMappingsByVCId-example/curl-request.adoc[]

==== Response Fields

include::{snippets}/assets-getMappingsByVCId-example/response-fields.adoc[]
...
include::{snippets}/assets-getAssetsByVCId-example/response-fields.adoc[]

[[resources-assets-getAssetsByVROPSId]]
=== getMappedAssetsByVROpsID

A `GET` request is used to access the assets read by VropsId.

==== Request structure

include::{snippets}/assets-getAssetsByVROPSId-example/http-request.adoc[]

==== Example response

include::{snippets}/assets-getAssetsByVROPSId-example/http-response.adoc[]

==== CURL request

include::{snippets}/assets-getAssetsByVROPSId-example/curl-request.adoc[]

==== Response Fields

include::{snippets}/assets-getAssetsByVROPSId-example/response-fields.adoc[]
...
include::{snippets}/facilitySoftware-syncFacilityServerData-example/request-fields.adoc[]
...
A `GET` request is used to access the sensorSetting read Setting.
...
[[resources-AuthController-readRoleNames]]
=== getAllRoleNames

A `GET` request is used to access the AuthController GET All RoleNames.

==== Request structure

include::{snippets}/AuthController-readRoleNames-example/http-request.adoc[]

==== Example response

include::{snippets}/AuthController-readRoleNames-example/http-response.adoc[]

==== CURL request

include::{snippets}/AuthController-readRoleNames-example/curl-request.adoc[]

==== Response Fields

include::{snippets}/AuthController-readRoleNames-example/response-fields.adoc[]
...
[[resources-AuthController-readAllUsers]]
=== getAllUsers

A `GET` request is used to access the AuthController GET All Users.

==== Request structure

include::{snippets}/AuthController-readAllUsers-example/http-request.adoc[]

==== Example response

include::{snippets}/AuthController-readAllUsers-example/http-response.adoc[]

==== CURL request

include::{snippets}/AuthController-readAllUsers-example/curl-request.adoc[]

==== Response Fields

include::{snippets}/AuthController-readAllUsers-example/response-fields.adoc[]
...
[[resources-AuthController-UserLogin]]
=== login
...
include::{snippets}/AuthController-UserLogin-example/http-request.adoc[]

==== Example response

include::{snippets}/AuthController-UserLogin-example/http-response.adoc[]

==== CURL request

include::{snippets}/AuthController-UserLogin-example/curl-request.adoc[]

==== Request Fields
include::{snippets}/AuthController-UserLogin-example/request-fields.adoc[]
