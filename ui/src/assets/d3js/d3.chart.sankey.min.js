        ...
        function (t, e, n) {
            ...
            t.exports = i.extend("Sankey", {
                initialize: function () {
                    ...
                    var i = this;
                    i.d3.sankey = s(), 
                    i.d3.path = i.d3.sankey.link(), 
                    i.d3.sankey.size([i.features.width, i.features.height]), 
                    i.features.spread = !1, 
                    i.features.iterations = 32, 
                    i.features.nodeWidth = i.d3.sankey.nodeWidth(), 
                    i.features.nodePadding = i.d3.sankey.nodePadding(), 
                    i.features.alignLabel = "auto", 
                    i.layers.links = i.layers.base.append("g").classed("links", !0), 
                    i.layers.nodes = i.layers.base.append("g").classed("nodes", !0), 
                    i.on("change:sizes", function () {
                        i.d3.sankey.nodeWidth(i.features.nodeWidth), 
                        i.d3.sankey.nodePadding(i.features.nodePadding)
                        ...
                        dataBind: function (t) {
                            ...
                            enter: function () {
                                this.append("rect"), this.append("text").attr("dy", ".35em").attr("transform", null).attr("width", this.width), this.on("mouseover", function (t) {
                                ...
                                this.attr("transform", function (t) {
                                    if(t.id == "host"){
                                        if(t.sourceLinks.length == 0){
                                            t.x = t.x/2;
                                        }
                                        if(t.y != 0 || flag_dy != 0){
                                            t.y = flag_y + flag_dy + 30;
                                        }
                                        flag_y = t.y;
                                        flag_dy = t.dy;
                                    }
                                    if(t.id == "pdu" || t.id == "switch"){
                                        if(t.y != 0 || flag_dy_child != 0){
                                            t.y = flag_y_dhild + flag_dy_child + 30;
                                        }
                                        flag_y_dhild = t.y;
                                        flag_dy_child = t.dy;
                                    }
                                    ...
                                    return t.dy
                                }).attr("width", i.features.nodeWidth).style("fill", e)
                                ...
                                , this.select("text").attr("font-size", "14px").text(i.features.name).attr("y", function (t) {
                                    return t.dy + 8
                                }).attr("x", function (e) {
                                    return "start" == t(e) ? i.features.nodeWidth - 22  : 17
                                }).attr("text-anchor", t)
                            }, exit: function () {
                                this.remove()
                            }
                    ...
                    i.layer("links", i.layers.links, {
                        dataBind: function (t) {
                            ...
                            .attr('id', function (d,i) {
                                return 'link_' + d.source.index + '_' +d.target.index;
                            })
                        }, events: {
                            enter: function () {
                                ...
                                this.attr("d", i.d3.path).style("stroke", n).style("stroke-width", function (t) {
                                    ...
                                    return e.dy - t.dy
                                }).style("stroke", "#1c82c7").style("stroke-opacity","0.2").style("fill-opacity", "0")
                            }, exit: function () {
                                this.remove()
                            }
                        }
                ...
                function o(t) {
                    ...
                    function s(t) {
                        ...
                        a.slice().reverse().forEach(function (n) {
                            n.forEach(function (n) {
                                if (n.sourceLinks.length || n.id == "host") {
