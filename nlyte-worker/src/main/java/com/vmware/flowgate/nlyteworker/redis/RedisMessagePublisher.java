...
*/
package com.vmware.flowgate.nlyteworker.redis;
...
public class RedisMessagePublisher implements MessagePublisher {
   ...
   @Value("${redis.topic:somethingneeded}")
   ...
   public void publish(String topic, String message) {
      ...
      logger.info(String.format("Send message: %s",publishedMessage));
   ...
   private String converToEventMessage(String message) {
      try {
         return EventMessageUtil.convertToEventMessageAsString(EventType.Nlyte, message);
      } catch (IOException e) {
