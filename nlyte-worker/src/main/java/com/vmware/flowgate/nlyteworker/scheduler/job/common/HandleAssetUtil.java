...
public class HandleAssetUtil {
	 ...
	 * @return asset
	 */
	public Asset supplementLocation(Asset asset, int locationGroupID, HashMap<Integer, LocationGroup> locationMap) {
	 ...
	 * @return
	 */
	public Asset supplementMaterial(Asset asset, int materialID, HashMap<Integer, Manufacturer> manufacturerMap,
