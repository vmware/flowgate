...
public class MetricKeyName {
   ...
   public static final String SERVER_FRONT_TEMPERATURE_LOCATIONX = "FrontTemperature|Location:%s";
   public static final String SERVER_BACK_TEMPREATURE_LOCATIONX = "BackTemperature|Location:%s";
   public static final String SERVER_FRONT_HUMIDITY_LOCATIONX = "FrontHumidity|Location:%s";
   public static final String SERVER_BACK_HUMIDITY_LOCATIONX = "BackHumidity|Location:%s";
