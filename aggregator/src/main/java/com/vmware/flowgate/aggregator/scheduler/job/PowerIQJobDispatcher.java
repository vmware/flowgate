...
public class PowerIQJobDispatcher extends BaseJob implements Job {
   ...
   // Read all the PowerIQ information, send to the redis topic
      ...
      boolean fullSync = execount++ % 280 == 0;
      ...
      try {
      template.opsForList().leftPushAll(EventMessageUtil.powerIQJobList, EventMessageUtil.generateFacilityMessageListByType(EventType.PowerIQ,
