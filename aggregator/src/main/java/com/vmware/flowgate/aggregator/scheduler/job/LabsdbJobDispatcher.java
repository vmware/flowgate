...
public class LabsdbJobDispatcher extends BaseJob implements Job{
   ...
   public void execute(JobExecutionContext context) throws JobExecutionException {
      ...
      FacilitySoftwareConfig[] labsdbs = restClient.getFacilitySoftwareByType(SoftwareType.Labsdb).getBody();
      ...
      try {
         if(fullSync) {
            ...
            template.opsForList().leftPushAll(EventMessageUtil.labsdbJobList, EventMessageUtil.generateFacilityMessageListByType(EventType.Labsdb,
         ...
         publisher.publish(EventMessageUtil.LabsdbTopic, EventMessageUtil.generateFacilityNotifyMessage(EventType.Labsdb));
         }catch(IOException e) {
